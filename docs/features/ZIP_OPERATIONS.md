# ZIP Operations Guide

## Overview

The FileManager component includes full support for ZIP file operations:
- Create ZIP archives from selected files/folders
- Extract ZIP files to the current directory
- Multi-file ZIP extraction support
